...
| `data-tutorial.js` | The complete guide: quick start + four parts. One source, three renderings |
| `src/*.js` | Modules, §4.2 |
...
| `docs/TUTORIAL.md` | **Generated** from `data-tutorial.js` by `tests/tools/gen-tutorial.mjs`; the harness regenerates and diffs it. The published page is a third rendering of the same data |
...
- [x] **Phase 10 — The complete guide**: `data-tutorial.js` rendered in-app, as `docs/TUTORIAL.md`
      and as a published page; every one of the app's 221 controls named, checked by the harness.

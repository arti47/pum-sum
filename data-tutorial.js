...
const WALKTHROUGH = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { p: "On a sheet that pairs with the plot-node extension sheet (Journey, Story-focus, Sandbox, Customized), a further card offers to name a list of your own: factions, rumours, omens, debts owed. Name it and it comes into being with the same ten slots and the same die rule." },
...
WALKTHROUGH.push(
  ...
  },
  {
    ...
    blocks: [
      { tap: "Play → Plot nodes" },
      { p: "Each list shows what you have written plus one empty slot, with 'Show all N slots' when you want the rest. The header carries the die the app will roll and how full the list is." },
      { bullets: [
  ...
  },
  {
    ...
    blocks: [
      { tap: "Journal" },
      { p: "Every roll the app makes lands here with its dice, so any result can be re-derived later. Thirteen filters cover every kind of entry the app writes. Entries page forty at a time and cap at five hundred." },
      { bullets: [
